public class HeronsFormulaNoFunction{
  public static void main(String[] args){
    ...
    s = (a+b+c) / 2.0;
    A = Math.sqrt(s*(s-a)*(s-b)*(s-c));
    System.out.println("A trianlge with sides 7,8,9 has area " + A);
...
//This one without the function is longer
//With the formula, you'd only have to change the 2 one time
